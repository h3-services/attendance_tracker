...
export default function Stepper({
    ...
    onBeforeComplete = null, // New: validation function, return false to block completion
        ...
        <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
            <motion.div
                variants={{
                    ...
                    active: { scale: 1, backgroundColor: '#0f172a', color: '#0f172a' },
                    complete: { scale: 1, backgroundColor: '#0f172a', color: '#fff' }
                }}
...
function StepConnector({ isComplete }) {
    const lineVariants = {
        ...
        complete: { width: '100%', backgroundColor: '#0f172a' }
    };
